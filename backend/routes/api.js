...
// // Login route (replace with your actual login logic)
// router.post('/login', (req, res) => {
//     // Implement login logic (e.g., authenticate user credentials)
...
//   // Register route (replace with your actual registration logic)
//   router.post('/register', (req, res) => {
//     // Implement registration logic (e.g., create new user)
...
//   .get(authMiddleware.authenticate, productController.getAllProducts)
//   .post(authMiddleware.authenticate, productController.createProduct);

// router.route('/products/:id')
//   .put(authMiddleware.authenticate, productController.updateProduct)
//   .delete(authMiddleware.authenticate, productController.deleteProduct);

// // Bidding routes
// router.route('/biddings')
//   .get(authMiddleware.authenticate, biddingController.getAllBiddings)
//   .post(authMiddleware.authenticate, biddingController.createBidding);

// router.route('/biddings/:id')
//   .put(authMiddleware.authenticate, biddingController.updateBidding)
//   .delete(authMiddleware.authenticate, biddingController.deleteBidding);

// // Contract routes
// router.route('/contracts')
//   .get(authMiddleware.authenticate, contractController.getAllContracts)
//   .post(authMiddleware.authenticate, contractController.createContract);

// router.route('/contracts/:id')
//   .put(authMiddleware.authenticate, contractController.updateContract)
//   .delete(authMiddleware.authenticate, contractController.deleteContract);
